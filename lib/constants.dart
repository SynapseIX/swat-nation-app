...
const String kGameContentUsageRules = 'Halo Infinite, Halo 5: Guardians, Halo: The Master Chief Collection © Microsoft Corporation. SWAT Nation was created under Microsoft\'s "Game Content Usage Rules" using assets from Halo Infinite, Halo 5: Guardians, Halo: The Master Chief Collection, and it is not endorsed by or affiliated with Microsoft.';
...
const String kFriendHasRequested = '%s sent you a friend request.';
